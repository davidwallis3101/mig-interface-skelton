...
Write-Host "Replacing Date and Version in Package.json"
...
Write-Host "Replacing Date and Version in Readme.TXT"
...
Write-Host "Replace Version in configlet.html"
...
Write-Host "Creating new interface archive"
